...
The page limit is 9 pages (excluding references and the appendix). Submissions may include supplementary material, but reviewers are only required to read the first 9 pages. Submissions should use the template provided by the [TBD style files](/). The reviewing process is double-blind. Parallel submissions (to a journal, conference, workshop, or preprint repository) and already published papers are allowed.
